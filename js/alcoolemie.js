...
function GetSex() {
    return getString('#sexe input[type="radio"]:checked');
}

function getNbVerres(){
    return document.getElementById('num_poids');
}

var poids = document.getElementById('num_poids');

var button = document.getElementById('btn');
button.addEventListener('click', function () {
        document.getElementById('test').innerHTML = getNbVerres();
    });
